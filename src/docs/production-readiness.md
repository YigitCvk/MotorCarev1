...
- [x] `Email` SMTP host, port, username, password ve FromName staging manuel testinde dogrulandi.
...
- [x] Test email verification ve password reset code.
- [ ] Test mobile viewport.
- [ ] UAT test plani ilk kullaniciyla tamamlandi.
